...
import backgroundimage1 from '../../assets/images/mediaassets/backgroundimage.png'
...
function MediaassetsMain() {
    return (
        <Box alignItems={"center"} sx={{ backgroundImage: `url(${backgroundimage1})`, height: "100%", backgroundRepeat: "no-repeat", display: "flex", justifyContent: "center", textAlign: "center", backgroundSize: "cover", backgroundPosition: "center" }}>
          ...
          color:"#c29943",
          transition:".3s"
        } }} fontWeight={600} variant='h4'>Media Assets</Typography>
                <div onClick={handleClick}>
                    <Breadcrumbs sx={{ display: "flex", justifyContent: "center" }}>
                        ...
                        <Link underline="none" fontWeight={700} href="/material-ui/getting-started/installation/" sx={{ color: "#C39C49", cursor: "default" }} > Media Assets </Link>
                    </Breadcrumbs>
                </div>
            </Box>
        </Box>
...
export default MediaassetsMain
