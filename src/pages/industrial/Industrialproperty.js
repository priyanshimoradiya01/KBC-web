...
function IndustrialProperty() {
    return (
    <Box sx={{backgroundColor:"#FAFAFA"}}>
        <Container>
            <Typography variant='h5' fontWeight={700} py={6} textAlign={"center"} sx={{"&:hover":{
          color:"#c29943",
          transition:".3s"
        }}}>Industrial Properties</Typography>
                    ...
                    <Grid item xs={12} sm={6} md={4} lg={4} key={index}>
                       <Box sx={{backgroundColor:"#FFFFFF",borderRadius:"21px",padding:"0px 1px",boxShadow:"0px 0px 10px #00000030"}}>
                             <Box sx={{backgroundImage: `url(${item.img})`,width: "100%",height: "350px",backgroundSize: "cover",display: "flex",justifyContent: "flex-end",flexDirection: "column",borderRadius:"20px",backgroundPosition:"center",}}>
                                  <Button sx={{bgcolor: "#C49D4B",color: "#fff",border: "2px solid #C49D4B",borderRadius: "0px 20px 0px 20px",alignSelf: "flex-start"}}>Commercial</Button>
                              </Box>
                              <Box paddingLeft={3} paddingBottom={2}>
                                     <Typography paddingTop={3} variant='h5' fontWeight={600}>Karunesh Textpa</Typography>
                                     <Typography variant='h7' sx={{color:"#8F8F8F"}}>Open Industrial Plot</Typography>
                              </Box>
            ...
            <Grid item xs={12} container spacing={3} py={5} display={"flex"} sx={{justifyContent:{md:"center"}}}s>
             <Grid item xs={12} sm={12} md={8} lg={6}>
                <Box sx={{backgroundImage:`url(${industrial4})`,height:"100%",backgroundSize:"cover",borderRadius:"10px"}}>
                      ...
                      <Box  gap={3} py={1} justifyContent={"center"} mx={6} sx={{display:{lg:"flex",md:"flex"}}}>
                        ...
                        <Box display={"flex"}  py={3} justifyContent={"start"} mx={6}>
                            {/* <Button sx={{backgroundColor:"#C49D4B",color:"white",padding:"10px 40px",borderRadius:"50px",fontWeight:"700","&:hover":{backgroundColor:"#ffff",color:"#C49D4B"}}}>Submit</Button> */}
             ...
             <Grid item xs={12} sm={12} md={8} lg={6}>
                 ...
                 <Box sx={{backgroundImage: `url(${industrial5})`, height: "100%", backgroundSize: "cover", borderRadius: "10px" }}>
                      ...
                      <Box sx={{display:{lg:"flex",md:"flex",sm:"flex",xs:"block"} ,justifyContent:{lg:"start",md:"start",sm:"start",xs:"center"}}} gap={3} mx={6} mt={3}>
                         <Button variant='outlined' sx={{marginBottom:"20px",backgroundColor:"#C49D4B",color:"white",padding:"10px 20px",borderRadius:"50px","&:hover":{borderColor:"#C49D4B"},transition:".7s",whiteSpace:{xs:"nowrap"}}}>About Dwarkesh Group</Button>
