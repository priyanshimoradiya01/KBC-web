  ...
  return (
    <Box alignItems={"center"} sx={{backgroundImage:`url(${bgimage})`,height:"100%",backgroundRepeat:"no-repeat",display:"flex",justifyContent:"center",textAlign:"center",backgroundPosition:"center",backgroundSize:"cover"}}>
      <Box sx={{marginTop:"200px",paddingBottom:"55px"}}>
        <Typography py={2} sx={{fontFamily:"Gothic A1, sans-serif",color:"white",fontSize:"36px","&:hover":{
          color:"#c29943",
          transition:".3s"
        }}} fontWeight={500} variant='h3'>Contact Us</Typography>
        <div  onClick={handleClick}>
          <Breadcrumbs sx={{display:"flex",justifyContent:"center"}}>
            ...
            <Link underline="none" fontWeight={700} href="/material-ui/getting-started/installation/" sx={{color:"#C39C49",cursor:"default"}} > Contact </Link>
          </Breadcrumbs>
        </div>
      </Box>
    </Box>
